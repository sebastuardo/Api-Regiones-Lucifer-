...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post queries_url, params: { query: { comune_name: @query.comune_name, privince_name: @query.privince_name } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { comune_name: @query.comune_name, privince_name: @query.privince_name } }
